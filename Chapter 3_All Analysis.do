...
/*CONTENT:
SECTION I: DATA CLEANING --------------------- LINES: 9 - 704
SECTION II: POINT ELASTICITY ESTIMATES ------- LINES: 713 - 799
SECTION III: REGRESSION MODELS --------------- LINES: 808 - 1068
*/

//SECTION I
//DATA CLEANING SECTION
use "C:\Users\aliye\Documents\Dissertation\Chapter 3\Analysis\Numeracy data\ms32numeracyonly.dta", replace
sort prim_key
save Data2, replace

use "C:\Users\aliye\Documents\Dissertation\Chapter 3\Analysis\Numeracy data\ms430numeracyonly.dta", replace
sort prim_key
save Data3, replace


use "C:\Users\aliye\Documents\Dissertation\Chapter 2\ms456\ALP_MS456_2017_01_19_04_40_42_weighted.dta", replace
set more off
sort prim_key
...
save DataCleaned4Reg, replace
*save DataCleaned4RegW, replace
...
//SECTION II
//DESCRIPTIVES FOR POINT ELASTICITIES (ESTIMATED FOR EACH INDIVIDUAL)

****************************** Calculating Point Elasticities for Each Individual ******************************
gen double eET10 = ((E1 - E0)/(T1 - T0))*(T0/E0) // Missed 127 observations because of 72 missing in E and 55 who have T = 0.
gen double eET20 = ((E2 - E0)/(T2 - T0))*(T0/E0)
gen double eET21 = ((E2 - E1)/(T2 - T1))*(T1/E1)
gen double eEA30 = ((E3 - E0)/(A3 - A0))*(A0/E0)
gen double eEA40 = ((E4 - E0)/(A4 - A0))*(A0/E0)
gen double eEA43 = ((E4 - E3)/(A4 - A3))*(A0/E0)
gen double eEP50 = ((E5 - E0)/(P5 - P0))*(P0/E0) // Missed 190 observations
gen double eEP60 = ((E6 - E0)/(P6 - P0))*(P0/E0)
gen double eEP65 = ((E6 - E5)/(P6 - P5))*(P5/E5)


svyset [pw=weight]
************************************************************************************
*TAX SCENARIOS
*Evasion Elasticity with Respect to Tax Rates (All observations)
svy: mean eET10
svy: mean eET20
svy: mean eET21

univar eET10 eET20 eET21
su eET10, detail
su eET20, detail
su eET21, detail


*Baseline Evasion by the Tax Scenarios (ONLY randomized observations)
svy: mean E0, over(randomtaxincrease)
svy: mean T0, over(randomtaxincrease)


*Evasion Elasticity with Respect to Tax Rates (ONLY randomized observations)
svy: mean eET10, over(randomtaxincrease)
lincom [eET10]_subpop_2 - [eET10]_subpop_1
svy: mean eET20, over(randomtaxincrease)
lincom [eET20]_subpop_2 - [eET20]_subpop_1
svy: mean eET21, over(randomtaxincrease)
lincom [eET21]_subpop_2 - [eET21]_subpop_1

ttest eET10, by(randomtaxincrease) //unweighted
ttest eET20, by(randomtaxincrease) //unweighted
ttest eET21, by(randomtaxincrease) //unweighted


************************************************************************************
*PENALTY SCENARIOS
*Evasion Elasticity with Respect to Penalty Rates (All observations)
svy: mean eEP50
svy: mean eEP60
svy: mean eEP65

univar eEP50 eEP60 eEP65
su eEP50
su eEP60
su eEP65

*Baseline Evasion by the Penalty Scenarios (ONLY randomized observations)
svy: mean E0, over(randompencondition)
svy: mean P0, over(randompencondition)


*Evasion Elasticity with Respect to Penalty Rates (ONLY randomized observations)
svy: mean eEP50, over(randompencondition)
lincom [eEP50]_subpop_2 - [eEP50]_subpop_1
svy: mean eEP60, over(randompencondition)
lincom [eEP60]_subpop_2 - [eEP60]_subpop_1
svy: mean eEP65, over(randompencondition)
lincom [eEP65]_subpop_2 - [eEP65]_subpop_1


************************************************************************************
*AUDIT SCENARIOS
*Evasion Elasticity with Respect to Penalty Rates
svy: mean eEA30
svy: mean eEA40
svy: mean eEA43

univar eEA30 eEA40 eEA43
su eEA30, detail
su eEA40, detail
su eEA43, detail
...
gen double expectedpenalty = P*pcaught
...
*S-curve for the tax margins by tax increase and tax decrease
*S-a) Margins calculated for randomtaxincrease and then for randomtaxdecrease
margins, over(randomtaxincrease) at(T = (0(0.01)1)) vsquish
marginsplot, noci

*S-b) Everyone is treated as tax-increase, and then as tax-decrease
margins randomtaxincrease, at(T = (0(0.01)1)) vsquish
marginsplot, noci

*S-c) Curves for the average marginal effect of tax by tax increase and tax decrease
margins, over(randomtaxincrease) dydx(T) at(T = (0(0.01) 1)) vsquish
marginsplot, noci

*S-d) Curves for the average marginal effect of tax by tax increase and tax decrease
margins randomtaxincrease, dydx(T) at(T = (0(0.01) 1)) vsquish
marginsplot, noci

*S-curve for the Penalty rate
margins, at(P = (0(0.01)2)) vsquish
marginsplot, noci

*S-curve for the Audit rate
margins, at(A = (0(0.01)1)) vsquish
marginsplot, noci

*Testing differences in the average marginal effect of tax increase and tax decrease
margins, dydx(*)
margins, over(randomtaxincrease) dydx(T) post
margins, coeflegend
test _b[T:1.randomtaxincrease] = _b[T:0bn.randomtaxincrease]


glm E c.T##i.randomtaxincrease A P $xlist1 [pw = weight], fa(bin) link(cloglog) cluster(id) nolog
mat b = e(b)
xtgee E c.T##i.randomtaxincrease A P  $xlist1 [pw = weight], fa(bin) link(cloglog) corr(exch) robust from(b, skip) nolog
margins, dydx(A P $xlist1)
margins, over(randomtaxincrease) eyex(T) post
margins, coeflegend
test _b[T:1.randomtaxincrease] = _b[T:0bn.randomtaxincrease]


*FRM: the same model but different command in order to estimate the marginal effect of the interaction term Trand
glm E T randomtaxincrease Trand A P $xlist1 [pw = weight], fa(bin) link(cloglog) cluster(id) nolog
mat b = e(b)
xtgee E T randomtaxincrease Trand A P  $xlist1 [pw = weight], fa(bin) link(cloglog) corr(exch) robust from(b, skip) nolog //A is positive, but insig. P is negative and insig.
margins, dydx(*)


******************************** Linear Mixed-Effect Models with the Panel Data ********************************
*Linear Mixed-Effect Model (Random Intercepts and coefficients)
*Linear ME model with covariance between random slope and intercept, all indep. vars
mixed E c.T##i.randomtaxincrease A P $xlist1 [pw=weight] || id: T A P, covariance(uns) nolog //All signs as expected and significant
estat ic

*Difference in average marginal effects between tax-increase and tax-decrease conditions
margins, over(randomtaxincrease) dydx(T)
margins, dydx(A P)


******************************** Generating Evasion-Curves for T, A and P ********************************
*I) Curve for T both models in one Plot
mixed E c.T##i.randomtaxincrease A P $xlist1 [pw=weight] || id: T A P, covariance(uns) nolog
margins, at(T = (0(0.01)1)) vsquish post
marginsplot, noci xtitle("Tax Rate") ytitle("Predicted Evasion Rate") name(Tax, replace) saving(EvasionCurveTaxME, replace)
est store ME
...
coefplot ME FRM, at xtitle("Tax Rate") ytitle("Predicted Evasion Rate") noci connect(l) saving(S-curveTaxOverallBothModels, replace)


*II) Evasion Curves by Tax Increase and Tax Decrease (FRM Only)
glm E c.T##i.randomtaxincrease A P $xlist1 [pw = weight], fa(bin) link(cloglog) cluster(id) nolog
mat b = e(b)
xtgee E c.T##i.randomtaxincrease A P  $xlist1 [pw = weight], fa(bin) link(cloglog) corr(exch) robust from(b, skip) nolog

*S-curve for the tax margins by tax increase and tax decrease
*S-1a) Margins calculated for randomtaxincrease and then for randomtaxdecrease
margins, over(randomtaxincrease) at(T = (0(0.01)1)) vsquish
marginsplot, noci xtitle("Tax Rate") ytitle("Predicted Evasion Rate") saving(EvasionCurveTaxByIncreaseAndDecreaseFRM, replace) name(Fig2a, replace)

*S-1b) Everyone is treated as tax-increase, and then as tax-decrease
margins randomtaxincrease, at(T = (0(0.01)1)) vsquish
marginsplot, noci

*S-1c) Curves for the average marginal effect of tax by tax increase and tax decrease
margins, over(randomtaxincrease) dydx(T) at(T = (0(0.01)1)) vsquish
marginsplot, noci xtitle("Tax Rate") ytitle("Effects on the Evasion Rate") saving(AMETaxByIncreaseAndDecreaseFRM, replace) name(Fig2b, replace)

graph combine Fig2a Fig2b

margins, over(randomtaxincrease) eyex(T) at(T = (0(0.01)1)) vsquish
marginsplot, noci xtitle("Tax Rate") ytitle("Evasion Elasticity") saving(EvasionElasticityByTaxIncreaseAndDecreaseFRM, replace)


*For the ME model the Average Marginal Effect Lines are two lines parallel to the x-axis indicating constant Average Marginal Effect.
mixed E c.T##i.randomtaxincrease A P $xlist1 [pw=weight] || id: T A P, covariance(uns) nolog
*S-2a) Margins calculated for randomtaxincrease and then for randomtaxdecrease
margins, over(randomtaxincrease) at(T = (0(0.01)1)) vsquish
marginsplot, noci xtitle("Tax Rate") ytitle("Predicted Evasion Rate") saving(EvasionCurveTaxByIncreaseAndDecreaseFRM, replace) name(Fig2a_ME, replace)

*S-2b) Everyone is treated as tax-increase, and then as tax-decrease
margins randomtaxincrease, at(T = (0(0.01)1)) vsquish
marginsplot, noci

*S-2c) Curves for the average marginal effect of tax by tax increase and tax decrease
margins, over(randomtaxincrease) dydx(T) at(T = (0(0.01)1)) vsquish
marginsplot, noci xtitle("Tax Rate") ytitle("Effects on the Evasion Rate") saving(AMETaxByIncreaseAndDecreaseFRM, replace) name(Fig2b_ME, replace)

graph combine Fig2a_ME Fig2b_ME

graph combine Fig2a Fig2b Fig2a_ME Fig2b_ME 



*III) Evasion Curve for Audit Rate
mixed E c.T##i.randomtaxincrease A P $xlist1 [pw=weight] || id: T A P, covariance(uns) nolog
*S-curve for the Audit rate
margins, at(A = (0(0.02)1)) vsquish post
marginsplot, noci xtitle("Audit Rate") ytitle("Predicted Evasion Rate") name(Audit, replace) saving(EvasionCurveAuditRateME, replace)
est store A_ME
...
coefplot A_ME A_FRM, at xtitle("Audit Rate") ytitle("Predicted Evasion Rate") noci connect(l) saving(AuditBothModels, replace)


*IV) Evasion Curve for Penalty Rate
*S-curve for the Penalty rate
mixed E c.T##i.randomtaxincrease A P $xlist1 [pw=weight] || id: T A P, covariance(uns) nolog
margins, at(P = (0(0.02)1)) vsquish post
marginsplot, noci xtitle("Penalty Rate") ytitle("Predicted Evasion Rate") name(Penalty, replace) saving(EvasionCurvePenaltyRateME, replace)
est store P_ME
...
coefplot P_ME P_FRM, at xtitle("Penalty Rate") ytitle("Predicted Evasion Rate") noci connect(l) saving(PenaltyBothModels, replace)



graph combine Audit Penalty, ycommon saving(EvasionCurvesPandA_ME, replace)

graph combine Tax Audit Penalty, saving(EvasionCurvesTAP_ME, replace)


******************************** Models with Expected Penalty (the Panel Data) ********************************

*EP1: Fractional Response Model (XTGEE)
*EP1_a) REPORTED
glm E c.T##i.randomtaxincrease A expectedpenalty $xlist1 [pw = weight], fa(bin) link(cloglog) cluster(id) nolog
mat b = e(b)
xtgee E c.T##i.randomtaxincrease A expectedpenalty $xlist1 [pw = weight], fa(bin) link(cloglog) corr(exch) robust from(b, skip) nolog //THE EXPECTEDPENALTY IS NEGATIVE BUT INSIGNIFICANT
margins, dydx(*)

*EP2: Mixed-Effects Model
*EP2_a) REPORTED
mixed E T A expectedpenalty randomtaxincrease Trand $xlist1 [pw=weight] || id: T A expectedpenalty, covariance(uns) nolog //THE EXPECTEDPENALTY IS NEGATIVE BUT INSIGNIFICANT

**************************** Regression Models Without Sampling Weights ****************************
*The ME model without sampling weights
mixed E c.T##i.randomtaxincrease A P $xlist1 || id: T A P, covariance(uns) nolog

*The FRM without sampling weights
glm E T randomtaxincrease Trand A P $xlist1 , fa(bin) link(cloglog) cluster(id) nolog
mat b = e(b)
xtgee E T randomtaxincrease Trand A P  $xlist1 , fa(bin) link(cloglog) corr(exch) robust from(b, skip) nolog
margins, dydx(*)


**************************** Elasticities for T, A and P Based on the Models ****************************
...
*Elasticities based on the ME model
mixed E c.T##i.randomtaxincrease A P $xlist1 [pw=weight] || id: T A P, covariance(uns) nolog
margins, dydx(T) at(T = (0 0.17 0.25 0.3 0.71 0.2591595 0.143)) vsquish
margins, at(T = (0 0.17 0.25 0.3 0.71 0.2591595 0.143)) vsquish

margins, dydx(A) at(A = (0.00055 0.1 0.2 0.3 0.8 0.2362086 0.007 0.00878)) vsquish
margins, at(A = (0.00055 0.1 0.2 0.3 0.8 .2362086 0.007 0.00878)) vsquish

margins, dydx(P) at(P = (0.002 0.1 0.2 0.5 15 2 0.7349642 0.2 0.75)) vsquish
margins, at(P = (0.002 0.1 0.2 0.5 15 2 0.7349642 0.2 0.75)) vsquish


*Elasticities based on the FRM
glm E c.T##i.randomtaxincrease A P $xlist1 [pw = weight], fa(bin) link(cloglog) cluster(id) nolog
mat b = e(b)
xtgee E c.T##i.randomtaxincrease A P  $xlist1 [pw = weight], fa(bin) link(cloglog) corr(exch) robust from(b, skip) nolog
margins, dydx(T) at(T = (0 0.17 0.25 0.3 0.71 0.2591595 0.143)) vsquish
margins, eyex(T) at(T = (0 0.17 0.25 0.3 0.71 0.2591595 0.143)) vsquish
margins, at(T = (0 0.17 0.25 0.3 0.71 0.2591595 0.143)) vsquish

margins, dydx(A) at(A = (0.00055 0.1 0.2 0.3 0.8 0.2362086 0.007 0.00878)) vsquish
margins, eyex(A) at(A = (0.00055 0.1 0.2 0.3 0.8 0.2362086 0.007 0.00878)) vsquish
margins, at(A = (0.00055 0.1 0.2 0.3 0.8 .2362086 0.007 0.00878)) vsquish

margins, dydx(P) at(P = (0.002 0.1 0.2 0.5 15 2 0.7349642 0.2 0.75)) vsquish
margins, eyex(P) at(P = (0.002 0.1 0.2 0.5 15 2 0.7349642 0.2 0.75)) vsquish
margins, at(P = (0.002 0.1 0.2 0.5 15 2 0.7349642 0.2 0.75)) vsquish
